    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                ...
                new Role { id = 2, name = "Cliente", description = "Cliente" }
            );
            ...
            new Product { id = 5, category_id = 2, name = "Maní salado 50g", description = "Bolsa de maní", price = 1500, stock = 90, image_url = "https://media.istockphoto.com/id/2149777376/photo/salted-roasted-peanuts-in-bowl-on-kitchen-table.jpg?s=612x612&w=0&k=20&c=Xb0yc6TXrYSqtGX4mtnQxhGORsmG0aXWtekhAgS85Ks=", is_active = true },
            new Product { id = 6, category_id = 2, name = "Nachos 70g", description = "Con queso", price = 2300, stock = 70, image_url = "https://stordfkenticomedia.blob.core.windows.net/df-us/rms/media/recipemediafiles/recipe%20images%20and%20files/k12/desktop%20(900x600)/2024/apr/2024_k12_ultimate-jalapeno-nachos_900x600.jpg?ext=.jpg", is_active = true },

            new Product { id = 7, category_id = 3, name = "Chocolate barra 40g", description = "70% cacao", price = 2000, stock = 50, image_url = "https://www.ferrerorocher.com/us/sites/ferrerorocher20_us/files/2025-08/250035-t1-rocher-dark-frontale-eng.png?t=1756883333", is_active = true },
            new Product { id = 8, category_id = 3, name = "Gomitas 90g", description = "Frutales", price = 1600, stock = 65, image_url = "http://sweetasfudge.com/cdn/shop/products/Assorted-Fruit-Slices-on-White.jpg?v=1681352307", is_active = true },
            ...
            // Seed: Users (contraseñas ya cifradas según EncryptCSS actual)
